                    ...
                    <div className="grid grid-cols-2 gap-12">
                        <div className="text-lg">
                            ...
                            <ul className="list-disc ml-8">
                                <li>
                                    Register (create a new passkey) or login
                                    (use an existing passkey).
                                </li>
                                <li>
                                    Send a UserOp, and observe that the first
                                    UserOp takes a lot of gas.
                                    <ul className="list-disc ml-4 mt-1">
                                        <li>
                                            This is because we need to verify
                                            the passkey.
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    Send more UserOps, and observe that they all
                                    cost a lot less gas than the first one.
                                    <ul className="list-disc ml-4 mt-1">
                                        <li>
                                            This is because the UserOps are sent
                                            through cheap ECDSA session keys.
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            <p className="mt-4">
                                To sum up, by combining passkeys with session
                                keys, we get the best of both worlds where the
                                user account is secured by their own passkey,
                                but UserOps are still cheap due to using ECDSA
                                session keys.
                            </p>
                        </div>
